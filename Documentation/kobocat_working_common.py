...
try:
    from default_settings import *  # nopep8
except ImportError:
    pass
...
#MONGO_CONNECTION = MongoClient(MONGO_CONNECTION_URL, safe=True, j=True, tz_aware=True)
MONGO_CONNECTION = MongoClient(MONGO_CONNECTION_URL)
